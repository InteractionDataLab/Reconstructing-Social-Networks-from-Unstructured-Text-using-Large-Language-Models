...
'),a=f.parent(),f.addClass(i.slides_container_class),i.navigation_arrows&&(a.append(e('<a href="#"></a>').addClass(i.prev_class)),a.append(e('<a href="#"></a>').addClass(i.next_class))),i.timer&&(h=e("
").addClass(i.timer_container_class),h.append(""),h.append(e("
...
<a class="parent-link js-generated" href="'+s+'">'+t.text()+"</a>
");else var o=e('
<a href="javascript:void(0)"></a>
...
Retrieved from " http://2014.igem.org/Team:USTC-Software/foundation.min.js "
Recent changes
What links here
Related changes
Special pages
