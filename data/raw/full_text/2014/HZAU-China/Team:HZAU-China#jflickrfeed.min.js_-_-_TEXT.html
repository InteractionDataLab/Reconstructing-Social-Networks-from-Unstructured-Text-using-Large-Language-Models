...
Log in
 
Team:HZAU-China/jflickrfeed.min.js
From 2014.igem.org
/*
...
return $(this).each(function(){var $container=$(this);var container=this;$.getJSON(url,function(data){$.each(data.items,function(i,item){if(i<settings.limit){if(settings.cleanDescription){var regex=/
...
Retrieved from " http://2014.igem.org/Team:HZAU-China/jflickrfeed.min.js "
Recent changes
What links here
Related changes
Special pages
