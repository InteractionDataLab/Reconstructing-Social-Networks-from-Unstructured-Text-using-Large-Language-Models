...
Log in
 
Team:Hong Kong HKUST/human practice/start-up kit/database/js/foundation.min.js
From 2014.igem.org
/*
...
');var r=n.detach(),i="";if(r[0]==null)return;i=r[0].outerHTML;var s=this.S("#foundationClearingHolder"),o=n.data(this.attr_name(!0)+"-init"),u={grid:'
'+i+"
",viewing:o.templates.viewing},a='
'+u.viewing+u.grid+"
...
'),l=c.parent(),c.addClass(s.slides_container_class),s.stack_on_small&&l.addClass(s.stack_on_small_class),s.navigation_arrows&&(l.append(e('<a href="#"></a>').addClass(s.prev_class)),l.append(e('<a href="#"></a>').addClass(s.next_class))),s.timer&&(d=e("
...
Foundation.libs["magellan-expedition"]={name
...
<a class="parent-link js-generated" href="'+s+'">'+t.html()+"</a>
"):o=e('
<a href="javascript:void(0)"></a>
...
Retrieved from " http://2014.igem.org/Team:Hong_Kong_HKUST/human_practice/start-up_kit/database/js/foundation.min.js "
Recent changes
What links here
Related changes
Special pages
