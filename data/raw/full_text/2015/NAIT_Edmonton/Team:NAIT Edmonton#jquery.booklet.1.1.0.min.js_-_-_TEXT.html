Team:NAIT Edmonton/jquery.booklet.1.1.0.min.js
/*
...
<a href="#/page/'+(L+1)+'" id="selector-page-'+L+'">'+aw[L+1]+''+nums+"</a>
").prependTo(v)}else{if(L==0){q.find(".b-current").text(nums)}an=b('
<a href="#/page/'+(L+1)+'" id="selector-page-'+L+'">'+aw[L]+''+nums+"</a>
...
<a href="#/page/'+(I+1)+'" id="selector-page-'+(I)+'">'+K[L]+"</a>
").prependTo(P)}else{au=b('
<a href="#/page/'+(L+1)+'" id="selector-page-'+L+'">'+K[L]+"</a>
