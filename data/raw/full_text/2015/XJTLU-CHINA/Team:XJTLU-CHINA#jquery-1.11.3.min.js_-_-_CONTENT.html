...
<BODY class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Team_XJTLU-CHINA_jquery-1_11_3_min_js skin-igem action-view"><DIV id="globalWrapper"><DIV id="content" class="mw-body" role="main"><H1 id="firstHeading" class="firstHeading"><SPAN dir="auto">Team:XJTLU-CHINA/jquery-1.11.3.min.js</SPAN></H1><DIV id="bodyContent"><DIV id="mw-content-text" lang="en" dir="ltr" class="mw-content-ltr"><P>/*!
</P><PRE>* jQuery JavaScript Library v1.11.3
* <A rel="nofollow" class="external free" href="http://jquery.com/">http://jquery.com/</A>
*
* Includes Sizzle.js
...
</P><P>// Can't do this because several apps including ASP.NET trace
// the stack via arguments.caller.callee and Firefox dies if
// you try to trace through &quot;use strict&quot; call chains. (#13335)
// Support: Firefox 18+
//
</P><P>var deletedIds = [];
</P><P>var slice = deletedIds.slice;
</P><P>var concat = deletedIds.concat;
</P><P>var push = deletedIds.push;
</P><P>var indexOf = deletedIds.indexOf;
</P><P>var class2type = {};
...
</P><P>	// Start with an empty selector
	selector: &quot;&quot;,
...
</P><P>	// See test/unit/core.js for details concerning isFunction.
	// Since version 1.3, DOM methods and functions like alert
	// aren't supported. They return false on IE (#2968).
	isFunction: function( obj ) {
		return jQuery.type(obj) === &quot;function&quot;;
	},
</P><P>	isArray: Array.isArray || function( obj ) {
...
</P><P>		// Own properties are enumerated firstly, so to speed up,
		// if last one is own, then all properties are own.
		for ( key in obj ) {}
</P><P>		return key === undefined || hasOwn.call( obj, key );
	},
	...
	// <A rel="nofollow" class="external free" href="http://weblogs.java.net/blog/driscoll/archive/2009/09/08/eval-javascript-global-context">http://weblogs.java.net/blog/driscoll/archive/2009/09/08/eval-javascript-global-context</A>
...
</P><P>	nodeName: function( elem, name ) {
		return elem.nodeName &amp;&amp; elem.nodeName.toLowerCase() === name.toLowerCase();
	},
</P><P>	// args is for internal usage only
...
</P><P>		// A special, fast, case for the most common use of each
		} else {
			if ( isArray ) {
				for ( ; i &lt; length; i++ ) {
...
</P><P>	merge: function( first, second ) {
...
</P><P>	// Support: iOS 8.2 (not reproducible in simulator)
...
var Sizzle =
/*!
</P><PRE>* Sizzle CSS Selector Engine v2.2.0-pre
* <A rel="nofollow" class="external free" href="http://sizzlejs.com/">http://sizzlejs.com/</A>
*
...
*/
	...
	// <A rel="nofollow" class="external free" href="http://jsperf.com/thor-indexof-vs-for/5">http://jsperf.com/thor-indexof-vs-for/5</A>
...
</P><P>	// Whitespace characters <A rel="nofollow" class="external free" href="http://www.w3.org/TR/css3-selectors/#whitespace">http://www.w3.org/TR/css3-selectors/#whitespace</A>
	whitespace = &quot;[\\x20\\t\\r\\n\\f]&quot;,
	// <A rel="nofollow" class="external free" href="http://www.w3.org/TR/css3-syntax/#characters">http://www.w3.org/TR/css3-syntax/#characters</A>
	characterEncoding = &quot;(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+&quot;,
</P><P>	// Loosely modeled on CSS identifier characters
	// An unquoted value should be a CSS identifier <A rel="nofollow" class="external free" href="http://www.w3.org/TR/css3-selectors/#attribute-selectors">http://www.w3.org/TR/css3-selectors/#attribute-selectors</A>
	// Proper syntax: <A rel="nofollow" class="external free" href="http://www.w3.org/TR/CSS21/syndata.html#value-def-identifier">http://www.w3.org/TR/CSS21/syndata.html#value-def-identifier</A>
	...
	rescape = /'|\\/g,
</P><P>	// CSS escapes <A rel="nofollow" class="external free" href="http://www.w3.org/TR/CSS21/syndata.html#escaped-characters">http://www.w3.org/TR/CSS21/syndata.html#escaped-characters</A>
...
</P><P>	if ( typeof selector !== &quot;string&quot; || !selector ||
		nodeType !== 1 &amp;&amp; nodeType !== 9 &amp;&amp; nodeType !== 11 ) {
</P><P>		return results;
	}
</P><P>	if ( !seed &amp;&amp; documentIsHTML ) {
</P><P>		// Try to shortcut find operations when possible (e.g., not under DocumentFragment)
...
</P><P>			// Speed-up: Sizzle(&quot;TAG&quot;)
			} else if ( match[2] ) {
				push.apply( results, context.getElementsByTagName( selector ) );
				return results;
</P><P>			// Speed-up: Sizzle(&quot;.CLASS&quot;)
...
</P><P>			// qSA works strangely on Element-rooted queries
...
*/
...
</P><P>	// If no document and documentElement is available, return
	if ( doc === document || doc.nodeType !== 9 || !doc.documentElement ) {
		return document;
	}
</P><P>	// Set our document
	document = doc;
	...
	// See <A rel="nofollow" class="external free" href="http://bugs.jquery.com/ticket/13378">http://bugs.jquery.com/ticket/13378</A>
	rbuggyQSA = [];
		...
		assert(function( div ) {
			...
			// <A rel="nofollow" class="external free" href="http://bugs.jquery.com/ticket/12359">http://bugs.jquery.com/ticket/12359</A>
			docElem.appendChild( div ).innerHTML = &quot;&lt;a id='&quot; + expando + &quot;'&gt;&lt;/a&gt;&quot; +
				&quot;&lt;select id='&quot; + expando + &quot;-\f]' msallowcapture=<I>&gt;&quot; +</I>
				&quot;&lt;option selected=<I>&gt;&lt;/option&gt;&lt;/select&gt;&quot;;</I></P><P>			// Support: IE8, Opera 11-12.16
			// Nothing should be selected when empty strings follow ^= or $= or *=
			// The test attribute must be unknown in Opera but &quot;safe&quot; for WinRT
			// <A rel="nofollow" class="external free" href="http://msdn.microsoft.com/en-us/library/ie/hh465388.aspx#attribute_section">http://msdn.microsoft.com/en-us/library/ie/hh465388.aspx#attribute_section</A>
			if ( div.querySelectorAll(&quot;[msallowcapture^=<I>]&quot;).length ) {</I>
...
</P><P>			// Support: Chrome&lt;29, Android&lt;4.2+, Safari&lt;7.0+, iOS&lt;7.0+, PhantomJS&lt;1.9.7+
...
</P><P>						// Use previously-cached element index if available
						} else if ( useCache &amp;&amp; (cache = (elem[ expando ] || (elem[ expando ] = {}))[ type ]) &amp;&amp; cache[0] === dirruns ) {
							diff = cache[1];
</P><P>						// xml :nth-child(...) or :nth-last-child(...) or :nth(-last)?-of-type(...)
						} else {
...
</P><P>			// We can't set arbitrary data on XML nodes, so they don't benefit from dir caching
			if ( xml ) {
				while ( (elem = elem[ dir ]) ) {
					if ( elem.nodeType === 1 || checkNonElements ) {
...
</P><P>	// Try to minimize operations if there is no seed and only one group
	if ( match.length === 1 ) {
</P><P>		// Take a shortcut and set the context if the root selector is an ID
...
// <A rel="nofollow" class="external free" href="http://msdn.microsoft.com/en-us/library/ms536429%28VS.85%29.aspx">http://msdn.microsoft.com/en-us/library/ms536429%28VS.85%29.aspx</A>
...
</P><P>var rneedsContext = jQuery.expr.match.needsContext;
</P><P>var rsingleTag = (/^&lt;(\w+)\s*\/?&gt;(?:&lt;\/\1&gt;|)$/);
</P><P>var risSimple = /^.[^:#\[\.,]*$/;
...
</P><P>	if ( qualifier.nodeType ) {
		return jQuery.grep( elements, function( elem ) {
			return ( elem === qualifier ) !== not;
		});
</P><P>	}
</P><P>	if ( typeof qualifier === &quot;string&quot; ) {
		if ( risSimple.test( qualifier ) ) {
			return jQuery.filter( qualifier, elements, not );
		}
</P><P>		qualifier = jQuery.filter( qualifier, elements );
	}
</P><P>	return jQuery.grep( elements, function( elem ) {
...
</P><P>	return elems.length === 1 &amp;&amp; elem.nodeType === 1 ?
...
</P><P>		// Needed because $( selector, context ) becomes $( context ).find( selector )
...
var rootjQuery,
</P><P>	// Use the correct document accordingly with window argument (sandbox)
	document = window.document,
</P><P>	// A simple way to check for HTML strings
	// Prioritize #id over &lt;tag&gt; to avoid XSS via location.hash (#9521)
	// Strict HTML recognition (#11290: must start with &lt;)
	rquickExpr = /^(?:\s*(&lt;[\w\W]+&gt;)[^&gt;]*|#([\w-]*))$/,
</P><P>	init = jQuery.fn.init = function( selector, context ) {
		var match, elem;
...
</P><P>					// scripts is true for back-compat
...
</P><P>					// Check parentNode to catch when Blackberry 4.6 returns
					// nodes that are no longer in the document #6963
					if ( elem &amp;&amp; elem.parentNode ) {
...
</P><P>						// Otherwise, we inject the element directly into the jQuery object
						this.length = 1;
						this[0] = elem;
					}
</P><P>					this.context = document;
...
</P><P>		if ( selector.selector !== undefined ) {
...
var rparentsprev = /^(?:parents|prev(?:Until|All))/,
	...
	dir: function( elem, dir, until ) {
		var matched = [],
			cur = elem[ dir ];
</P><P>		while ( cur &amp;&amp; cur.nodeType !== 9 &amp;&amp; (until === undefined || cur.nodeType !== 1 || !jQuery( cur ).is( until )) ) {
			if ( cur.nodeType === 1 ) {
				matched.push( cur );
			}
			cur = cur[dir];
...
</P><P>		return this.pushStack( matched.length &gt; 1 ? jQuery.unique( matched ) : matched );
	},
</P><P>	// Determine the position of an element within
...
var rnotwhite = (/\S+/g);
</P><P>// String to Object options format cache
var optionsCache = {};
</P><P>// Convert String-formatted options into Object-formatted ones and store in cache
...
jQuery.extend({
		...
		jQuery.each( tuples, function( i, tuple ) {
			var list = tuple[ 2 ],
				stateString = tuple[ 3 ];
</P><P>			// promise[ done | fail | progress ] = list.add
			...
			if ( stateString ) {
				list.add(function() {
					...
					state = stateString;
</P><P>				// [ reject_list | resolve_list ].disable; progress_list.lock
				}, tuples[ i ^ 1 ][ 2 ].disable, tuples[ 2 ][ 2 ].lock );
			}
</P><P>			// deferred[ resolve | reject | notify ]
...
</P><P>			// the count of uncompleted subordinates
			remaining = length !== 1 || ( subordinate &amp;&amp; jQuery.isFunction( subordinate.promise ) ) ? length : 0,
</P><P>			// the master Deferred. If resolveValues consist of only a single Deferred, just use that.
			deferred = remaining === 1 ? subordinate : jQuery.Deferred(),
</P><P>			// Update function for both resolve and progress values
...
</P><P>					} else if ( !(--remaining) ) {
						deferred.resolveWith( contexts, values );
					}
				};
			},
</P><P>			progressValues, progressContexts, resolveContexts;
</P><P>		// add listeners to Deferred subordinates; treat others as resolved
		if ( length &gt; 1 ) {
...
</P><P>		// if we're not waiting on anything, resolve the master
		if ( !remaining ) {
			deferred.resolveWith( resolveContexts, resolveValues );
		}
</P><P>		return deferred.promise();
	}
});
</P><P>
...
var readyList;
	...
	readyWait: 1,
</P><P>	// Hold (or release) the ready event
...
</P><P>		// Make sure body exists, at least, in case IE gets a little overzealous (ticket #5443).
		if ( !document.body ) {
...
</P><P>		// Trigger any bound ready events
...
</P><PRE>* Clean-up method for dom ready events
*/
</PRE><P>function detach() {
...
</P><PRE>* The ready event handler and self cleanup method
*/
</PRE><P>function completed() {
...
</P><P>jQuery.ready.promise = function( obj ) {
	if ( !readyList ) {
</P><P>		readyList = jQuery.Deferred();
</P><P>		// Catch cases where $(document).ready() is called after the browser event has already occurred.
		// we once tried to use readyState &quot;interactive&quot; here, but it caused issues like the one
		// discovered by ChrisS here: <A rel="nofollow" class="external free" href="http://bugs.jquery.com/ticket/12282#comment:15">http://bugs.jquery.com/ticket/12282#comment:15</A>
		if ( document.readyState === &quot;complete&quot; ) {
			// Handle it asynchronously to allow scripts the opportunity to delay ready
			setTimeout( jQuery.ready );
</P><P>		// Standards-based browsers support DOMContentLoaded
		} else if ( document.addEventListener ) {
			// Use the handy event callback
			document.addEventListener( &quot;DOMContentLoaded&quot;, completed, false );
</P><P>			// A fallback to window.onload, that will always work
			window.addEventListener( &quot;load&quot;, completed, false );
</P><P>		// If IE event model is used
		} else {
			// Ensure firing before onload, maybe late but safe also for iframes
			document.attachEvent( &quot;onreadystatechange&quot;, completed );
</P><P>			// A fallback to window.onload, that will always work
			window.attachEvent( &quot;onload&quot;, completed );
</P><P>			// If IE and not a frame
			// continually check to see if the document is ready
			var top = false;
</P><P>			try {
				top = window.frameElement == null &amp;&amp; document.documentElement;
			} catch(e) {}
</P><P>			if ( top &amp;&amp; top.doScroll ) {
				(function doScrollCheck() {
					if ( !jQuery.isReady ) {
</P><P>						try {
							// Use the trick by Diego Perini
							// <A rel="nofollow" class="external free" href="http://javascript.nwbox.com/IEContentLoaded/">http://javascript.nwbox.com/IEContentLoaded/</A>
							top.doScroll(&quot;left&quot;);
						} catch(e) {
							return setTimeout( doScrollCheck, 50 );
						}
</P><P>						// detach all dom ready events
						detach();
</P><P>						// and execute any waiting functions
						jQuery.ready();
					}
				})();
			}
...
support.ownLast = i !== &quot;0&quot;;
</P><P>// Note: most support tests are defined in their respective modules.
// false until the test is run
support.inlineBlockNeedsLayout = false;
</P><P>// Execute ASAP in case we need to set body.style.zoom
jQuery(function() {
	// Minified: var a,b,c,d
	var val, div, body, container;
</P><P>	body = document.getElementsByTagName( &quot;body&quot; )[ 0 ];
	if ( !body || !body.style ) {
...
</P><P>	if ( typeof div.style.zoom !== strundefined ) {
		// Support: IE&lt;8
		// Check if natively block-level elements act like inline-block
		// elements when setting their display to 'inline' and giving
		// them layout
		div.style.cssText = &quot;display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1&quot;;
</P><P>		support.inlineBlockNeedsLayout = val = div.offsetWidth === 3;
		if ( val ) {
...
(function() {
	var div = document.createElement( &quot;div&quot; );
</P><P>	// Execute the test only if not already executed in another module.
...
</P><P>	// Null elements to avoid leaks in IE.
	div = null;
})();
</P><P>
/**
</P><PRE>* Determines whether an object can have data
*/
</PRE><P>jQuery.acceptData = function( elem ) {
	var noData = jQuery.noData[ (elem.nodeName + &quot; &quot;).toLowerCase() ],
		nodeType = +elem.nodeType || 1;
</P><P>	// Do not set data on non-element DOM nodes because it will not be cleared (#8335).
	return nodeType !== 1 &amp;&amp; nodeType !== 9 ?
		false :
</P><P>		// Nodes accept data unless otherwise specified; rejection can be conditional
...
</P><P>		var name = &quot;data-&quot; + key.replace( rmultiDash, &quot;-$1&quot; ).toLowerCase();
</P><P>		data = elem.getAttribute( name );
...
</P><P>// checks a cache object for emptiness
function isEmptyDataObject( obj ) {
	var name;
	for ( name in obj ) {
</P><P>		// if the public data object is empty, the private is still empty
...
</P><P>function internalData( elem, name, data, pvt /* Internal Use Only */ ) {
	if ( !jQuery.acceptData( elem ) ) {
		return;
	}
</P><P>	var ret, thisCache,
		internalKey = jQuery.expando,
</P><P>		// We have to handle DOM nodes and JS objects differently because IE6-7
		// can't GC object references properly across the DOM-JS boundary
		isNode = elem.nodeType,
</P><P>		// Only DOM nodes need the global jQuery cache; JS object data is
		// attached directly to the object so GC can occur automatically
		cache = isNode ? jQuery.cache : elem,
</P><P>		// Only defining an ID for JS objects if its cache already exists allows
		// the code to shortcut on the same path as a DOM node with no cache
		id = isNode ? elem[ internalKey ] : elem[ internalKey ] &amp;&amp; internalKey;
</P><P>	// Avoid doing any more work than we need to when trying to get data on an
...
</P><P>	// An object can be passed to jQuery.data instead of a key/value pair; this gets
...
</P><P>	thisCache = cache[ id ];
</P><P>	// jQuery data() is stored in a separate object inside the object's internal data
...
</P><P>		thisCache = thisCache.data;
	}
</P><P>	if ( data !== undefined ) {
		thisCache[ jQuery.camelCase( name ) ] = data;
	}
</P><P>	// Check for both converted-to-camel and non-converted data property names
	// If a data property was specified
	if ( typeof name === &quot;string&quot; ) {
</P><P>		// First Try to find as-is property data
		ret = thisCache[ name ];
</P><P>		// Test for null|undefined property data
		if ( ret == null ) {
</P><P>			// Try to find the camelCased property
...
</P><P>function internalRemoveData( elem, name, pvt ) {
	if ( !jQuery.acceptData( elem ) ) {
		return;
	}
</P><P>	var thisCache, i,
		isNode = elem.nodeType,
</P><P>		// See jQuery.data for more information
		cache = isNode ? jQuery.cache : elem,
		id = isNode ? elem[ jQuery.expando ] : jQuery.expando;
</P><P>	// If there is already no cache entry for this object, there is no
	// purpose in continuing
	if ( !cache[ id ] ) {
		return;
	}
</P><P>	if ( name ) {
</P><P>		thisCache = pvt ? cache[ id ] : cache[ id ].data;
</P><P>		if ( thisCache ) {
</P><P>			// Support array or space separated string names for data keys
			if ( !jQuery.isArray( name ) ) {
</P><P>				// try the string as a key before any manipulation
				if ( name in thisCache ) {
					name = [ name ];
				} else {
</P><P>					// split the camel cased version by spaces unless a key with the spaces exists
...
</P><P>			// If there is no data left in the cache, we want to continue
...
</P><P>		// Don't destroy the parent cache unless the internal data object
		// had been the only thing left in it
		if ( !isEmptyDataObject( cache[ id ] ) ) {
			return;
		}
	}
</P><P>	// Destroy the cache
	if ( isNode ) {
		jQuery.cleanData( [ elem ], true );
</P><P>	// Use delete when supported for expandos or `cache` is not a window per isWindow (#10080)
	/* jshint eqeqeq: false */
	} else if ( support.deleteExpando || cache != cache.window ) {
		/* jshint eqeqeq: true */
		delete cache[ id ];
</P><P>	// When all else fails, null
	} else {
		cache[ id ] = null;
	}
}
	...
	cache: {},
</P><P>	// The following elements (space-suffixed to avoid Object.prototype collisions)
...
</P><P>		// Special expections of .data basically thwart jQuery.access,
		// so implement the relevant behavior ourselves
</P><P>		// Gets all values
		if ( key === undefined ) {
			if ( this.length ) {
				data = jQuery.data( elem );
</P><P>				if ( elem.nodeType === 1 &amp;&amp; !jQuery._data( elem, &quot;parsedAttrs&quot; ) ) {
					i = attrs.length;
					while ( i-- ) {
</P><P>						// Support: IE11+
...
</P><P>	// not intended for public consumption - generates a queueHooks object, or returns the current one
...
</P><P>var cssExpand = [ &quot;Top&quot;, &quot;Right&quot;, &quot;Bottom&quot;, &quot;Left&quot; ];
</P><P>var isHidden = function( elem, el ) {
		// isHidden might be called from jQuery#filter function;
		// in that case, element will be second argument
		elem = el || elem;
		return jQuery.css( elem, &quot;display&quot; ) === &quot;none&quot; || !jQuery.contains( elem.ownerDocument, elem );
	};
</P><P>// Multifunctional method to get and set values of a collection
...
<P>	// IE strips leading whitespace when .innerHTML is used
	support.leadingWhitespace = div.firstChild.nodeType === 3;
</P><P>	// Make sure that tbody elements aren't automatically inserted
	// IE will insert them into empty tables
	support.tbody = !div.getElementsByTagName( &quot;tbody&quot; ).length;
</P><P>	// Make sure that link elements get serialized correctly by innerHTML
	// This requires a wrapper element in IE
	support.htmlSerialize = !!div.getElementsByTagName( &quot;link&quot; ).length;
</P><P>	// Makes sure cloning an html5 element does not cause problems
	// Where outerHTML is undefined, this still works
	support.html5Clone =
		document.createElement( &quot;nav&quot; ).cloneNode( true ).outerHTML !== &quot;&lt;:nav&gt;&lt;/:nav&gt;&quot;;
</P><P>	// Check if a disconnected checkbox will retain its checked
	// value of true after appended to the DOM (IE6/7)
	input.type = &quot;checkbox&quot;;
	input.checked = true;
	fragment.appendChild( input );
	support.appendChecked = input.checked;
</P><P>	// Make sure textarea (and checkbox) defaultValue is properly cloned
	// Support: IE6-IE11+
	div.innerHTML = &quot;&lt;textarea&gt;x&lt;/textarea&gt;&quot;;
	support.noCloneChecked = !!div.cloneNode( true ).lastChild.defaultValue;
</P><P>	// #11217 - WebKit loses check when the name is after the checked attribute
	fragment.appendChild( div );
	div.innerHTML = &quot;&lt;input type='radio' checked='checked' name='t'/&gt;&quot;;
</P><P>	// Support: Safari 5.1, iOS 5.1, Android 4.x, Android 2.3
...
(function() {
	var i, eventName,
		div = document.createElement( &quot;div&quot; );
</P><P>	// Support: IE&lt;9 (lack submit/change bubble), Firefox 23+ (lack focusin event)
	for ( i in { submit: true, change: true, focusin: true }) {
		eventName = &quot;on&quot; + i;
</P><P>		if ( !(support[ i + &quot;Bubbles&quot; ] = eventName in window) ) {
			// Beware of CSP restrictions (<A rel="nofollow" class="external free" href="https://developer.mozilla.org/en/Security/CSP">https://developer.mozilla.org/en/Security/CSP</A>)
...
</P><P>function safeActiveElement() {
	try {
...
*/
...
</P><P>				// Only use addEventListener/attachEvent if the special events handler returns false
				if ( !special.setup || special.setup.call( elem, data, namespaces, eventHandle ) === false ) {
					// Bind the global event handler to the element
					if ( elem.addEventListener ) {
						elem.addEventListener( type, eventHandle, false );
</P><P>					} else if ( elem.attachEvent ) {
...
</P><P>		// Nullify elem to prevent memory leaks in IE
		elem = null;
	},
...
</P><P>		// Remove the expando if it's no longer used
		if ( jQuery.isEmptyObject( events ) ) {
			delete elemData.handle;
</P><P>			// removeData also checks for emptiness and clears the expando if empty
...
</P><P>			if ( (!special._default || special._default.apply( eventPath.pop(), data ) === false) &amp;&amp;
				jQuery.acceptData( elem ) ) {
</P><P>				// Call a native DOM method on the target with the same name name as the event.
...
</P><P>				// Triggered event must either 1) have no namespace, or
				// 2) have namespace(s) a subset or equal to those in the bound event (both can have no namespace).
				if ( !event.namespace_re || event.namespace_re.test( handleObj.namespace ) ) {
</P><P>					event.handleObj = handleObj;
					event.data = handleObj.data;
</P><P>					ret = ( (jQuery.event.special[ handleObj.origType ] || {}).handle || handleObj.handler )
...
</P><P>	fix: function( event ) {
		if ( event[ jQuery.expando ] ) {
			return event;
		}
</P><P>		// Create a writable copy of the event object and normalize some properties
		var i, prop, copy,
			type = event.type,
			originalEvent = event,
...
</P><P>		event = new jQuery.Event( originalEvent );
</P><P>		i = copy.length;
		while ( i-- ) {
			prop = copy[ i ];
...
</P><P>		return fixHook.filter ? fixHook.filter( event, originalEvent ) : event;
	},
</P><P>	// Includes some event props shared by KeyEvent and MouseEvent
...
</P><P>			// Calculate pageX/Y if missing and clientX/Y available
			if ( event.pageX == null &amp;&amp; original.clientX != null ) {
				eventDoc = event.target.ownerDocument || document;
				doc = eventDoc.documentElement;
				body = eventDoc.body;
</P><P>				event.pageX = original.clientX + ( doc &amp;&amp; doc.scrollLeft || body &amp;&amp; body.scrollLeft || 0 ) - ( doc &amp;&amp; doc.clientLeft || body &amp;&amp; body.clientLeft || 0 );
				event.pageY = original.clientY + ( doc &amp;&amp; doc.scrollTop  || body &amp;&amp; body.scrollTop  || 0 ) - ( doc &amp;&amp; doc.clientTop  || body &amp;&amp; body.clientTop  || 0 );
			}
</P><P>			// Add relatedTarget, if necessary
...
</P><P>	simulate: function( type, elem, event, bubble ) {
...
</P><P>jQuery.removeEvent = document.removeEventListener ?
	...
	function( elem, type, handle ) {
		var name = &quot;on&quot; + type;
</P><P>		if ( elem.detachEvent ) {
</P><P>			// #8545, #7054, preventing memory leaks for custom events in IE6-8
			// detachEvent needed property on element, by name of that event, to properly expose it to GC
			if ( typeof elem[ name ] === strundefined ) {
				elem[ name ] = null;
			}
</P><P>			elem.detachEvent( name, handle );
		}
	};
...
// <A rel="nofollow" class="external free" href="http://www.w3.org/TR/2003/WD-DOM-Level-3-Events-20030331/ecma-script-binding.html">http://www.w3.org/TR/2003/WD-DOM-Level-3-Events-20030331/ecma-script-binding.html</A>
...
</P><P>		// If preventDefault exists, run it on the original event
		if ( e.preventDefault ) {
			e.preventDefault();
</P><P>		// Support: IE
...
</P><P>		if ( e &amp;&amp; e.stopImmediatePropagation ) {
...
</P><P>			// For mousenter/leave call the handler if related is outside the target.
...
</P><P>// IE submit delegation
if ( !support.submitBubbles ) {
</P><P>	jQuery.event.special.submit = {
		setup: function() {
			// Only need this for delegated form submit events
			if ( jQuery.nodeName( this, &quot;form&quot; ) ) {
				return false;
			}
</P><P>			// Lazy-add a submit handler when a descendant form may potentially be submitted
...
</P><P>		postDispatch: function( event ) {
...
</P><P>			// Remove delegated handlers; cleanData eventually reaps submit handlers attached above
			jQuery.event.remove( this, &quot;._submit&quot; );
		}
	};
}
</P><P>// IE change delegation and checkbox/radio fix
if ( !support.changeBubbles ) {
</P><P>	jQuery.event.special.change = {
</P><P>		setup: function() {
</P><P>			if ( rformElems.test( this.nodeName ) ) {
			...
			jQuery.event.add( this, &quot;beforeactivate._change&quot;, function( e ) {
				var elem = e.target;
</P><P>				if ( rformElems.test( elem.nodeName ) &amp;&amp; !jQuery._data( elem, &quot;changeBubbles&quot; ) ) {
...
</P><P>			// Swallow native change events from checkbox/radio, we already triggered them above
...
</P><P>			return !rformElems.test( this.nodeName );
		}
	};
}
</P><P>// Create &quot;bubbling&quot; focus and blur events
...
</P><P>	on: function( types, selector, data, fn, /*INTERNAL*/ one ) {
		var type, origFn;
...
</P><P>var nodeNames = &quot;abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|&quot; +
...
</P><P>wrapMap.optgroup = wrapMap.option;
wrapMap.tbody = wrapMap.tfoot = wrapMap.colgroup = wrapMap.caption = wrapMap.thead;
wrapMap.th = wrapMap.td;
</P><P>function getAll( context, tag ) {
	var elems, elem,
		i = 0,
...
</P><P>	return tag === undefined || tag &amp;&amp; jQuery.nodeName( context, tag ) ?
		jQuery.merge( [ context ], found ) :
		found;
}
</P><P>// Used in buildFragment, fixes the defaultChecked property
...
</P><P>		elem.getElementsByTagName(&quot;tbody&quot;)[0] ||
...
</P><P>// Mark scripts as having already been evaluated
...
</P><P>	if ( dest.nodeType !== 1 || !jQuery.hasData( src ) ) {
		return;
	}
</P><P>	var type, i, l,
...
</P><P>	// make the cloned public data object a copy from the original
	if ( curData.data ) {
		curData.data = jQuery.extend( {}, curData.data );
	}
}
</P><P>function fixCloneNodeIssues( src, dest ) {
	var nodeName, e, data;
</P><P>	// We do not need to do anything for non-Elements
	if ( dest.nodeType !== 1 ) {
		return;
	}
</P><P>	nodeName = dest.nodeName.toLowerCase();
</P><P>	// IE6-8 copies events bound via attachEvent when using cloneNode.
	if ( !support.noCloneEvent &amp;&amp; dest[ jQuery.expando ] ) {
		data = jQuery._data( dest );
</P><P>		for ( e in data.events ) {
			jQuery.removeEvent( dest, e, data.handle );
		}
</P><P>		// Event data gets referenced instead of copied if the expando gets copied too
		dest.removeAttribute( jQuery.expando );
	}
</P><P>	// IE blanks contents when cloning scripts, and tries to evaluate newly-set text
	if ( nodeName === &quot;script&quot; &amp;&amp; dest.text !== src.text ) {
		disableScript( dest ).text = src.text;
		restoreScript( dest );
</P><P>	// IE6-10 improperly clones children of object elements using classid.
	// IE10 throws NoModificationAllowedError if parent is null, #12132.
	} else if ( nodeName === &quot;object&quot; ) {
		if ( dest.parentNode ) {
			dest.outerHTML = src.outerHTML;
		}
</P><P>		// This path appears unavoidable for IE9. When cloning an object
...
</P><P>	} else if ( nodeName === &quot;input&quot; &amp;&amp; rcheckableType.test( src.type ) ) {
		// IE6-8 fails to persist the checked state of a cloned checkbox
		// or radio button. Worse, IE6-7 fail to give the cloned element
		// a checked appearance if the defaultChecked value isn't also set
</P><P>		dest.defaultChecked = dest.checked = src.checked;
</P><P>		// IE6-7 get confused and end up setting the value of a cloned
		// checkbox/radio button to an empty string instead of &quot;on&quot;
		if ( dest.value !== src.value ) {
			dest.value = src.value;
		}
</P><P>	// IE6-8 fails to return the selected option to the default selected
	// state when cloning options
	} else if ( nodeName === &quot;option&quot; ) {
		dest.defaultSelected = dest.selected = src.defaultSelected;
</P><P>	// IE6-8 fails to set the defaultValue to the correct value when
...
</P><P>		if ( support.html5Clone || jQuery.isXMLDoc(elem) || !rnoshimcache.test( &quot;&lt;&quot; + elem.nodeName + &quot;&gt;&quot; ) ) {
			clone = elem.cloneNode( true );
</P><P>		// IE&lt;=8 does not properly clone detached, unknown element nodes
		} else {
			fragmentDiv.innerHTML = elem.outerHTML;
			fragmentDiv.removeChild( clone = fragmentDiv.firstChild );
		}
</P><P>		if ( (!support.noCloneEvent || !support.noCloneChecked) &amp;&amp;
				(elem.nodeType === 1 || elem.nodeType === 11) &amp;&amp; !jQuery.isXMLDoc(elem) ) {
</P><P>			// We eschew Sizzle here for performance reasons: <A rel="nofollow" class="external free" href="http://jsperf.com/getall-vs-sizzle/2">http://jsperf.com/getall-vs-sizzle/2</A>
			destElements = getAll( clone );
			srcElements = getAll( elem );
</P><P>			// Fix all IE cloning issues
...
</P><P>				for ( i = 0; (node = srcElements[i]) != null; i++ ) {
...
</P><P>		destElements = srcElements = node = null;
</P><P>		// Return the cloned set
		return clone;
	},
</P><P>	buildFragment: function( elems, context, scripts, selection ) {
		var j, elem, contains,
			tmp, tag, tbody, wrap,
			l = elems.length,
</P><P>			// Ensure a safe fragment
...
</P><P>					tmp.innerHTML = wrap[1] + elem.replace( rxhtmlTag, &quot;&lt;$1&gt;&lt;/$2&gt;&quot; ) + wrap[2];
</P><P>					// Descend through wrappers to the right content
					j = wrap[0];
					while ( j-- ) {
						tmp = tmp.lastChild;
					}
</P><P>					// Manually add leading whitespace removed by IE
					if ( !support.leadingWhitespace &amp;&amp; rleadingWhitespace.test( elem ) ) {
						nodes.push( context.createTextNode( rleadingWhitespace.exec( elem )[0] ) );
					}
</P><P>					// Remove IE's autoinserted &lt;tbody&gt; from table fragments
					if ( !support.tbody ) {
</P>
...
if ( window.getComputedStyle ) {
	...
	curCSS = function( elem, name, computed ) {
		...
		if ( computed ) {
			...
			// this is against the CSSOM draft spec: <A rel="nofollow" class="external free" href="http://dev.w3.org/csswg/cssom/#resolved-values">http://dev.w3.org/csswg/cssom/#resolved-values</A>
	...
	curCSS = function( elem, name, computed ) {
		...
		// <A rel="nofollow" class="external free" href="http://erik.eae.net/archives/2007/07/27/18.54.15/#comment-102291">http://erik.eae.net/archives/2007/07/27/18.54.15/#comment-102291</A>
...
(function() {
	...
	div = document.createElement( &quot;div&quot; );
	div.innerHTML = &quot;  &lt;link/&gt;&lt;a href='/a'&gt;a&lt;/a&gt;&lt;input type='checkbox'/&gt;&quot;;
<P>	a = div.getElementsByTagName( &quot;a&quot; )[ 0 ];
	style = a &amp;&amp; a.style;
</P><P>	// Finish early in limited (non-browser) environments
	if ( !style ) {
		return;
	}
</P><P>	style.cssText = &quot;float:left;opacity:.5&quot;;
</P><P>	// Support: IE&lt;9
	// Make sure that element opacity exists (as opposed to filter)
	support.opacity = style.opacity === &quot;0.5&quot;;
</P><P>	// Verify style float existence
	// (IE uses styleFloat instead of cssFloat)
	support.cssFloat = !!style.cssFloat;
</P><P>	div.style.backgroundClip = &quot;content-box&quot;;
	div.cloneNode( true ).style.backgroundClip = &quot;&quot;;
	support.clearCloneStyle = div.style.backgroundClip === &quot;content-box&quot;;
</P><P>	// Support: Firefox&lt;29, Android 2.3
	// Vendor-prefix box-sizing
	support.boxSizing = style.boxSizing === &quot;&quot; || style.MozBoxSizing === &quot;&quot; ||
...
</P><P>		boxSizingReliable: function() {
			if ( boxSizingReliableVal == null ) {
				computeStyleTests();
			}
			return boxSizingReliableVal;
		},
</P><P>		pixelPosition: function() {
			if ( pixelPositionVal == null ) {
				computeStyleTests();
			}
			return pixelPositionVal;
		},
</P><P>		// Support: Android 2.3
...
</P><P>	function computeStyleTests() {
...
</P><P>		// Check for getComputedStyle so that this code is not run in IE&lt;9.
		if ( window.getComputedStyle ) {
...
</P><P>			// Reset CSS: box-sizing; display; margin; border; padding
			...
			div.style.width = &quot;1px&quot;;
</P><P>			reliableMarginRightVal =
				!parseFloat( ( window.getComputedStyle( contents, null ) || {} ).marginRight );
</P><P>			div.removeChild( contents );
		}
</P><P>		// Support: IE8
		...
		div.innerHTML = &quot;<TABLE><TBODY><TR><TD>t</TD></TR></TBODY></TABLE>&quot;;
<P>		contents = div.getElementsByTagName( &quot;td&quot; );
...
</P><P>	// swappable if display is none or starts with table except &quot;table&quot;, &quot;table-cell&quot;, or &quot;table-caption&quot;
...
</P><P>	cssShow = { position: &quot;absolute&quot;, visibility: &quot;hidden&quot;, display: &quot;block&quot; },
	cssNormalTransform = {
		letterSpacing: &quot;0&quot;,
		fontWeight: &quot;400&quot;
	},
</P><P>	cssPrefixes = [ &quot;Webkit&quot;, &quot;O&quot;, &quot;Moz&quot;, &quot;ms&quot; ];
</P><P>
...
function vendorPropName( style, name ) {
...
</P><P>		values[ index ] = jQuery._data( elem, &quot;olddisplay&quot; );
...
</P><P>			// Set elements which have been overridden with display: none
...
</P><P>			if ( display &amp;&amp; display !== &quot;none&quot; || !hidden ) {
				jQuery._data( elem, &quot;olddisplay&quot;, hidden ? display : jQuery.css( elem, &quot;display&quot; ) );
			}
		}
	}
</P><P>	// Set the display of most of the elements in a second loop
...
</P><P>	// Start with offset property, which is equivalent to the border-box value
	var valueIsBorderBox = true,
		val = name === &quot;width&quot; ? elem.offsetWidth : elem.offsetHeight,
		styles = getStyles( elem ),
		isBorderBox = support.boxSizing &amp;&amp; jQuery.css( elem, &quot;boxSizing&quot;, false, styles ) === &quot;border-box&quot;;
</P><P>	// some non-html elements return undefined for offsetWidth, so check for null/undefined
	// svg - <A rel="nofollow" class="external free" href="https://bugzilla.mozilla.org/show_bug.cgi?id=649285">https://bugzilla.mozilla.org/show_bug.cgi?id=649285</A>
	// MathML - <A rel="nofollow" class="external free" href="https://bugzilla.mozilla.org/show_bug.cgi?id=491668">https://bugzilla.mozilla.org/show_bug.cgi?id=491668</A>
	if ( val &lt;= 0 || val == null ) {
...
</P><P>		// we need the check for style in case a browser which returns unreliable values
	...
	style: function( elem, name, value, extra ) {
		...
		var ret, type, hooks,
			...
			style = elem.style;
</P><P>		name = jQuery.cssProps[ origName ] || ( jQuery.cssProps[ origName ] = vendorPropName( style, origName ) );
</P><P>		// gets hook for the prefixed version
		// followed by the unprefixed version
		hooks = jQuery.cssHooks[ name ] || jQuery.cssHooks[ origName ];
</P><P>		// Check if we're setting a value
		if ( value !== undefined ) {
			type = typeof value;
</P><P>			// convert relative number strings (+= or -=) to relative numbers. #7345
			if ( type === &quot;string&quot; &amp;&amp; (ret = rrelNum.exec( value )) ) {
				value = ( ret[1] + 1 ) * ret[2] + parseFloat( jQuery.css( elem, name ) );
				// Fixes bug #9237
				type = &quot;number&quot;;
			}
</P><P>			// Make sure that null and NaN values aren't set. See: #7116
			if ( value == null || value !== value ) {
				return;
			}
</P><P>			// If a number was passed in, add 'px' to the (except for certain CSS properties)
			if ( type === &quot;number&quot; &amp;&amp; !jQuery.cssNumber[ origName ] ) {
				value += &quot;px&quot;;
			}
</P><P>			// Fixes #8908, it can be done more correctly by specifing setters in cssHooks,
...
</P><P>		// Return, converting to number if forced or a qualifier was provided and val looks numeric
		if ( extra === &quot;&quot; || extra ) {
			num = parseFloat( val );
...
</P><P>			// IE has trouble with opacity if it does not have layout
			// Force it by setting the zoom level
			style.zoom = 1;
</P><P>			// if setting opacity to 1, and no other filters exist - attempt to remove filter attribute #6652
			// if value === &quot;&quot;, then remove inline opacity #12685
			if ( ( value &gt;= 1 || value === &quot;&quot; ) &amp;&amp;
					jQuery.trim( filter.replace( ralpha, &quot;&quot; ) ) === &quot;&quot; &amp;&amp;
					style.removeAttribute ) {
</P><P>				// Setting style.filter to null, &quot;&quot; &amp; &quot; &quot; still leave &quot;filter:&quot; in the cssText
				// if &quot;filter:&quot; is present at all, clearType is disabled, we want to avoid this
				// style.removeAttribute is IE Only, but so apparently is this code path...
				style.removeAttribute( &quot;filter&quot; );
</P><P>				// if there is no filter style applied in a css rule or unset inline opacity, we are done
				if ( value === &quot;&quot; || currentStyle &amp;&amp; !currentStyle.filter ) {
					return;
				}
			}
</P><P>			// otherwise, set new filter values
...
</P><P>jQuery.cssHooks.marginRight = addGetHookIf( support.reliableMarginRight,
...
jQuery.Tween = Tween;
	...
	_default: {
		get: function( tween ) {
			var result;
</P><P>			if ( tween.elem[ tween.prop ] != null &amp;&amp;
...
</P><P>Tween.propHooks.scrollTop = Tween.propHooks.scrollLeft = {
	set: function( tween ) {
...
function genFx( type, includeWidth ) {
...
</P><P>	// handle queue: false promises
	if ( !opts.queue ) {
...
</P><P>	// height/width overflow pass
...
</P><P>		// Set display property to inline-block for height/width
		// animations on inline elements that are having width/height animated
		display = jQuery.css( elem, &quot;display&quot; );
</P><P>		// Test default display if display is currently &quot;none&quot;
		checkDisplay = display === &quot;none&quot; ?
			jQuery._data( elem, &quot;olddisplay&quot; ) || defaultDisplay( elem.nodeName ) : display;
</P><P>		if ( checkDisplay === &quot;inline&quot; &amp;&amp; jQuery.css( elem, &quot;float&quot; ) === &quot;none&quot; ) {
</P><P>			// inline-level elements accept inline-block;
...
</P><P>				// If there is dataShow left over from a stopped hide or show and we are going to proceed with show, we should pretend to be hidden
...
</P><P>		// Any non-fx value stops us from restoring the original display value
		} else {
			display = undefined;
		}
	}
</P><P>	if ( !jQuery.isEmptyObject( orig ) ) {
		if ( dataShow ) {
...
</P><P>		// store state if its toggle - enables .stop().toggle() to &quot;reverse&quot;
		if ( toggle ) {
...
</P><P>	// If this is a noop like .hide().hide(), restore an overwritten display value
	...
	for ( index in props ) {
		...
		if ( hooks &amp;&amp; &quot;expand&quot; in hooks ) {
			...
			delete props[ name ];
</P><P>			// not quite $.extend, this wont overwrite keys already present.
...
</P><P>				// resolve when we played the last frame
				// otherwise, reject
				if ( gotoEnd ) {
...
</P><P>	opt.duration = jQuery.fx.off ? 0 : typeof opt.duration === &quot;number&quot; ? opt.duration :
...
// <A rel="nofollow" class="external free" href="http://blindsignals.com/index.php/2009/07/jquery-delay/">http://blindsignals.com/index.php/2009/07/jquery-delay/</A>
...
(function() {
	...
	div.innerHTML = &quot;  &lt;link/&gt;&lt;a href='/a'&gt;a&lt;/a&gt;&lt;input type='checkbox'/&gt;&quot;;
<P>	a = div.getElementsByTagName(&quot;a&quot;)[ 0 ];
</P><P>	// First batch of tests.
	select = document.createElement(&quot;select&quot;);
	opt = select.appendChild( document.createElement(&quot;option&quot;) );
	input = div.getElementsByTagName(&quot;input&quot;)[ 0 ];
</P><P>	a.style.cssText = &quot;top:1px&quot;;
</P><P>	// Test setAttribute on camelCase class. If it works, we need attrFixes when doing get/setAttribute (ie6/7)
	support.getSetAttribute = div.className !== &quot;t&quot;;
</P><P>	// Get the style information from getAttribute
	// (IE uses .cssText instead)
	support.style = /top/.test( a.getAttribute(&quot;style&quot;) );
</P><P>	// Make sure that URLs aren't manipulated
	// (IE normalizes it by default)
	support.hrefNormalized = a.getAttribute(&quot;href&quot;) === &quot;/a&quot;;
</P><P>	// Check the default checkbox/radio value (&quot;&quot; on WebKit; &quot;on&quot; elsewhere)
	support.checkOn = !!input.value;
</P><P>	// Make sure that a selected-by-default option has a working selected property.
	// (WebKit defaults to false instead of true, IE too, if it's in an optgroup)
	support.optSelected = opt.selected;
</P><P>	// Tests for enctype support on a form (#6743)
	support.enctype = !!document.createElement(&quot;form&quot;).enctype;
</P><P>	// Make sure that the options inside disabled selects aren't marked as disabled
	// (WebKit marks them as disabled)
	select.disabled = true;
	support.optDisabled = !opt.disabled;
</P><P>	// Support: IE8 only
	// Check if we can trust getAttribute(&quot;value&quot;)
	input = document.createElement( &quot;input&quot; );
	input.setAttribute( &quot;value&quot;, &quot;&quot; );
	support.input = input.getAttribute( &quot;value&quot; ) === &quot;&quot;;
</P><P>	// Check if an input maintains its value after becoming a radio
	input.value = &quot;t&quot;;
...
</P><P>				if ( hooks &amp;&amp; &quot;get&quot; in hooks &amp;&amp; (ret = hooks.get( elem, &quot;value&quot; )) !== undefined ) {
					return ret;
				}
</P><P>				ret = elem.value;
</P><P>				return typeof ret === &quot;string&quot; ?
	...
	valHooks: {
		...
		select: {
			get: function( elem ) {
				...
				for ( ; i &lt; max; i++ ) {
					option = options[ i ];
</P><P>					// oldIE doesn't update selected after form reset (#2551)
				...
				var optionSet, option,
					...
					option = options[ i ];
</P><P>					if ( jQuery.inArray( jQuery.valHooks.option.get( option ), values ) &gt;= 0 ) {
</P><P>						// Support: IE6
...
</P><P>							// Will be executed only in IE6
							option.scrollHeight;
						}
</P><P>					} else {
...
</P><P>		// All attributes are lowercase
...
</P><P>			} else if ( hooks &amp;&amp; &quot;set&quot; in hooks &amp;&amp; (ret = hooks.set( elem, value, name )) !== undefined ) {
				return ret;
</P><P>			} else {
				elem.setAttribute( name, value + &quot;&quot; );
				return value;
			}
</P><P>		} else if ( hooks &amp;&amp; &quot;get&quot; in hooks &amp;&amp; (ret = hooks.get( elem, name )) !== null ) {
			return ret;
</P><P>		} else {
...
</P><P>				// Boolean attributes get special treatment (#10870)
...
</P><P>				// See #9699 for explanation of this approach (setting first, then removal)
				} else {
					jQuery.attr( elem, name, &quot;&quot; );
				}
</P><P>				elem.removeAttribute( getSetAttribute ? name : propName );
			}
		}
	},
</P><P>	attrHooks: {
...
</P><P>// Hook for boolean attributes
boolHook = {
...
</P><P>		// Use defaultChecked and defaultSelected for oldIE
		} else {
...
</P><P>// Retrieve booleans specially
jQuery.each( jQuery.expr.match.bool.source.match( /\w+/g ), function( i, name ) {
</P><P>	var getter = attrHandle[ name ] || jQuery.find.attr;
</P><P>	attrHandle[ name ] = getSetInput &amp;&amp; getSetAttribute || !ruseDefault.test( name ) ?
...
</P><P>// IE6/7 do not support getting/setting some attributes with get/setAttribute
if ( !getSetAttribute ) {
</P><P>	// Use this for any attribute in IE6/7
...
</P><P>			// Break association with cloned elements by also using setAttribute (#9646)
			if ( name === &quot;value&quot; || value === elem.getAttribute( name ) ) {
				return value;
			}
		}
	};
</P><P>	// Some attributes are constructed with empty-string values when not defined
...
</P><P>	// Fixing value retrieval on a button requires this module
...
</P><P>	// Set contenteditable to false on removals(#10429)
...
</P><P>	// Set width and height to auto instead of 0 on empty string( Bug #8150 )
	...
	propFix: {
...
</P><P>	prop: function( elem, name, value ) {
...
</P><P>		notxml = nType !== 1 || !jQuery.isXMLDoc( elem );
</P><P>		if ( notxml ) {
		...
		tabIndex: {
			get: function( elem ) {
				...
				// <A rel="nofollow" class="external free" href="http://fluidproject.org/blog/2008/01/09/getting-setting-and-removing-tabindex-values-with-javascript/">http://fluidproject.org/blog/2008/01/09/getting-setting-and-removing-tabindex-values-with-javascript/</A>
...
</P><P>// Some attributes require a special call on IE
// <A rel="nofollow" class="external free" href="http://msdn.microsoft.com/en-us/library/ms536429%28VS.85%29.aspx">http://msdn.microsoft.com/en-us/library/ms536429%28VS.85%29.aspx</A>
...
</P><P>				// Make sure that it also works with optgroups, see #5701
...
</P><P>// IE6/7 call enctype encoding
if ( !support.enctype ) {
...
</P><P>var rvalidtokens = /(,)|(\[|{)|(}|])|&quot;(?:[^&quot;\\\r\n]|\\[&quot;\\\/bfnrt]|\\u[\da-fA-F]{4})*&quot;\s*:?|true|false|null|-?(?!0\d)\d+(?:\.\d+|)(?:[eE][+-]?\d+|)/g;
</P><P>jQuery.parseJSON = function( data ) {
...
</P><P>	var requireNonComma,
		depth = null,
		str = jQuery.trim( data + &quot;&quot; );
</P><P>	// Guard against invalid (and possibly dangerous) input by ensuring that nothing remains
	// after removing valid tokens
	return str &amp;&amp; !jQuery.trim( str.replace( rvalidtokens, function( token, comma, open, close ) {
</P><P>		// Force termination if we see a misplaced comma
		if ( requireNonComma &amp;&amp; comma ) {
			depth = 0;
		}
</P><P>		// Perform no more replacements after returning to outermost depth
		if ( depth === 0 ) {
			return token;
		}
</P><P>		// Commas must not follow &quot;[&quot;, &quot;{&quot;, or &quot;,&quot;
		requireNonComma = open || comma;
</P><P>		// Determine new depth
		// array/object open (&quot;[&quot; or &quot;{&quot;): depth += true - false (increment)
		// array/object close (&quot;]&quot; or &quot;}&quot;): depth += false - true (decrement)
		// other cases (&quot;,&quot; or primitive): depth += true - true (numeric cast)
		depth += !close - !open;
</P><P>		// Remove this token
		return &quot;&quot;;
	}) ) ?
		( Function( &quot;return &quot; + str ) )() :
...
var
	...
	allTypes = &quot;*/&quot;.concat(&quot;*&quot;);
</P><P>// #8138, IE may throw an exception when accessing
...
</P><P>// Segment location into parts
...
*/
	...
	ajax: function( url, options ) {
		...
		options = options || {};
</P><P>		var // Cross-domain detection vars
			parts,
			// Loop variable
			i,
...
</P><P>		// Remove hash character (#7531: and string promotion)
...
</P><P>		// A cross-domain request is in order when we have a protocol:host:port mismatch
...
</P><P>			// Add anti-cache in url if needed
			if ( s.cache === false ) {
				s.url = rts.test( cacheURL ) ?
</P><P>					// If there is already a '_' parameter, set its value
					cacheURL.replace( rts, &quot;$1_=&quot; + nonce++ ) :
</P><P>					// Otherwise add one to the end
	...
	wrapAll: function( html ) {
		if ( jQuery.isFunction( html ) ) {
			...
			var wrap = jQuery( html, this[0].ownerDocument ).eq(0).clone(true);
				...
				var elem = this;
</P><P>				while ( elem.firstChild &amp;&amp; elem.firstChild.nodeType === 1 ) {
...
</P><P>jQuery.expr.filters.visible = function( elem ) {
...
</P><P>	// Set traditional to true for jQuery &lt;= 1.3.2 behavior.
...
jQuery.ajaxSettings.xhr = window.ActiveXObject !== undefined ?
	// Support: IE6+
	function() {
</P><P>		// XHR cannot access local files, always use ActiveX for that case
		return !this.isLocal &amp;&amp;</P><P>			// Support: IE7-8
			// oldIE XHR does not support non-RFC2616 methods (#13240)
			// See <A rel="nofollow" class="external free" href="http://msdn.microsoft.com/en-us/library/ie/ms536648(v=vs.85).aspx">http://msdn.microsoft.com/en-us/library/ie/ms536648(v=vs.85).aspx</A>
			// and <A rel="nofollow" class="external free" href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec9.html#sec9">http://www.w3.org/Protocols/rfc2616/rfc2616-sec9.html#sec9</A>
			// Although this check for six methods instead of eight
			// since IE also does not support &quot;trace&quot; and &quot;connect&quot;
			/^(get|post|head|put|delete|options)$/i.test( this.type ) &amp;&amp;</P><P>			createStandardXHR() || createActiveXHR();
	} :
...
// See <A rel="nofollow" class="external free" href="https://support.microsoft.com/kb/2856746">https://support.microsoft.com/kb/2856746</A> for more info
...
</P><P>// Determine support properties
support.cors = !!xhrSupported &amp;&amp; ( &quot;withCredentials&quot; in xhrSupported );
xhrSupported = support.ajax = !!xhrSupported;
</P><P>// Create transport if the browser can provide an xhr
if ( xhrSupported ) {
...
</P><P>						// Was never called and is aborted or complete
						if ( callback &amp;&amp; ( isAbort || xhr.readyState === 4 ) ) {
							// Clean up
							delete xhrCallbacks[ id ];
							callback = undefined;
							xhr.onreadystatechange = jQuery.noop;
</P><P>							// Abort manually if needed
							if ( isAbort ) {
								if ( xhr.readyState !== 4 ) {
									xhr.abort();
								}
...
</P><P>								// Firefox throws an exception when accessing
...
</P><P>								// Filter status for non standard behaviors
</P><P>								// If the request is local and we have data: assume a success
...
</P><P>						// Call complete if needed
						if ( responses ) {
							complete( status, statusText, responses, xhr.getAllResponseHeaders() );
						}
					};
</P><P>					if ( !options.async ) {
...
</P><P>// Functions to create xhrs
function createStandardXHR() {
	try {
		return new window.XMLHttpRequest();
	} catch( e ) {}
}
</P><P>function createActiveXHR() {
	try {
...
</P><P>// Handle cache's special case and global
...
</P><P>			send: function( _, callback ) {
</P><P>				script = document.createElement(&quot;script&quot;);
</P><P>				script.async = true;
</P><P>				if ( s.scriptCharset ) {
					script.charset = s.scriptCharset;
				}
</P><P>				script.src = s.url;
</P><P>				// Attach handlers for all browsers
				script.onload = script.onreadystatechange = function( _, isAbort ) {
</P><P>					if ( isAbort || !script.readyState || /loaded|complete/.test( script.readyState ) ) {
</P><P>						// Handle memory leak in IE
						script.onload = script.onreadystatechange = null;
</P><P>						// Remove the script
						if ( script.parentNode ) {
							script.parentNode.removeChild( script );
						}
</P><P>						// Dereference the script
						script = null;
</P><P>						// Callback if not abort
						if ( !isAbort ) {
							callback( 200, &quot;success&quot; );
						}
					}
				};
</P><P>				// Circumvent IE6 bugs with base elements (#2709 and #4378) by prepending
...
</P><P>	var parsed = rsingleTag.exec( data ),
		scripts = !keepScripts &amp;&amp; [];
</P><P>	// Single tag
	if ( parsed ) {
		return [ context.createElement( parsed[1] ) ];
	}
</P><P>	parsed = jQuery.buildFragment( [ data ], context, scripts );
...
</P><P>	var selector, response, type,
		self = this,
		off = url.indexOf(&quot; &quot;);
</P><P>	if ( off&gt;= 0 ) {
...
<P>				// Otherwise use the full result
				responseText );
</P><P>		}).complete( callback &amp;&amp; function( jqXHR, status ) {
...
</P><PRE>* Gets a window from an element
*/
</PRE><P>function getWindow( elem ) {
...
</P><P>		// need to be able to calculate position if either top or left is auto and position is either absolute or fixed
	...
	offset: function( options ) {
...
</P><P>		docElem = doc.documentElement;
</P><P>		// Make sure it's not a disconnected DOM node
		if ( !jQuery.contains( docElem, elem ) ) {
			return box;
		}
</P><P>		// If we don't have gBCR, just use 0,0 rather than error
		...
		if ( !this[ 0 ] ) {
			...
			elem = this[ 0 ];
</P><P>		// fixed elements are offset from window (parentOffset = {top:0, left: 0}, because it is its only offset parent
...
</P><P>			while ( offsetParent &amp;&amp; ( !jQuery.nodeName( offsetParent, &quot;html&quot; ) &amp;&amp; jQuery.css( offsetParent, &quot;position&quot; ) === &quot;static&quot; ) ) {
...
</P><P>// Add the top/left cssHooks using jQuery.fn.position
		...
		jQuery.fn[ funcName ] = function( margin, value ) {
			var chainable = arguments.length &amp;&amp; ( defaultExtra || typeof margin !== &quot;boolean&quot; ),
				...
				var doc;
					...
					// <A rel="nofollow" class="external free" href="https://github.com/jquery/jquery/pull/764">https://github.com/jquery/jquery/pull/764</A>
					return elem.document.documentElement[ &quot;client&quot; + name ];
				}
</P><P>				// Get document width or height
				if ( elem.nodeType === 9 ) {
					doc = elem.documentElement;
</P><P>					// Either scroll[Width/Height] or offset[Width/Height] or client[Width/Height], whichever is greatest
...
</P><P>jQuery.fn.andSelf = jQuery.fn.addBack;
</P><P>
...
</P><P>// Expose jQuery and $ identifiers, even in
// AMD (#7102#comment:10, <A rel="nofollow" class="external free" href="https://github.com/jquery/jquery/pull/557">https://github.com/jquery/jquery/pull/557</A>)
...
}));</DIV></TABLE></TABLE></DIV></DIV></DIV></DIV></BODY></HTML>