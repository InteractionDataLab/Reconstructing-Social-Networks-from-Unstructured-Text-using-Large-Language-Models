Team:NCHU Taichung/js/semantic.min.js
/* * # Semantic UI - 2.2.12 * https://github.com/Semantic-Org/Semantic-UI * http://www.semantic-ui.com/ * * Copyright 2014 Contributors * Released under the MIT license * http://opensource.org/licenses/MIT * */
...
'+e+"
",n+="
"),n},category:function(t,n){var i="";e.fn.search.settings.templates.escape;return void 0!==t[n.categoryResults]&&(e.each(t[n.categoryResults],function(t,o){void 0!==o[n.results]&&o.results.length>0&&(i+='
',void 0!==o[n.categoryName]&&(i+='
'+o[n.categoryName]+"
"),e.each(o.results,function(e,t){t[n.url]?i+='<a class="result" href="'+t[n.url]+'">':i+='<a class="result">',void 0!==t[n.image]&&(i+='
<img src="'+t[n.image]+'">
'),i+='
',void 0!==t[n.price]&&(i+='
'+t[n.price]+"
"),void 0!==t[n.title]&&(i+='
'+t[n.title]+"
"),void 0!==t[n.description]&&(i+='
'+t[n.description]+"
"),i+="
",i+="</a>"}),i+="
")}),t[n.action]&&(i+='<a href="'+t[n.action][n.actionURL]+'" class="action">'+t[n.action][n.actionText]+"</a>"),i)},standard:function(t,n){var i="";return void 0!==t[n.results]&&(e.each(t[n.results],function(e,t){t[n.url]?i+='<a class="result" href="'+t[n.url]+'">':i+='<a class="result">',void 0!==t[n.image]&&(i+='
<img src="'+t[n.image]+'">
'),i+='
',void 0!==t[n.price]&&(i+='
'+t[n.price]+"
