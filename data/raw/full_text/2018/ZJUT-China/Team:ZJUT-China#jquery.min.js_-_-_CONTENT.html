...
<BODY class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Team_ZJUT-China_jquery_min_js skin-igem action-view"><DIV id="globalWrapper"><DIV id="content" class="mw-body" role="main"><DIV id="top_title"><H1 id="firstHeading" class="firstHeading"><SPAN dir="auto">Team:ZJUT-China/jquery.min.js</SPAN></H1></DIV><DIV id="HQ_page"><DIV id="bodyContent"><DIV id="mw-content-text" lang="en" dir="ltr" class="mw-content-ltr"><P>/*!
</P><PRE>* jQuery JavaScript Library v3.3.1
...
</P><P>var isFunction = function isFunction( obj ) {
</P><PRE>     // Support: Chrome &lt;=57, Firefox &lt;=52
...
</P><P>	function DOMEval( code, doc, node ) {
		doc = doc || document;
</P><P>		var i,
...
// unguarded in another place, it seems safer to define global only for this module
	...
	jquery: version,
</P><P>	constructor: jQuery,</P><P>	// The default length of a jQuery object is 0
	length: 0,
...
function( i, name ) {
	...
	var length = !!obj &amp;&amp; &quot;length&quot; in obj &amp;&amp; obj.length,
		type = toType( obj );
</P><P>	if ( isFunction( obj ) || isWindow( obj ) ) {
		return false;
	}
...
</P><P>	// Filtered directly for both simple and complex selectors
...
*/
	...
	options = typeof options === &quot;string&quot; ?
		...
		queue = [],
</P><P>		// Index of currently firing callback (modified by add/remove as needed)
		firingIndex = -1,
</P><P>		// Fire callbacks
		fire = function() {
...
</P><P>					// rejected_handlers.disable
					// fulfilled_handlers.disable
					tuples[ 3 - i ][ 3 ].disable,
</P><P>					// progress_callbacks.lock
					tuples[ 0 ][ 2 ].lock,
</P><P>					// progress_handlers.lock
					tuples[ 0 ][ 3 ].lock
				);
			}
...
var rmsPrefix = /^-ms-/,
	rdashAlpha = /-([a-z])/g;
</P><P>// Used by camelCase as callback to replace()
...
</P><P>		while ( maxIterations-- ) {
</P><P>			// Evaluate and update our best guess (doubling guesses that zero out).
...
</P><P>		initialInUnit = initialInUnit * 2;
		jQuery.style( elem, prop, initialInUnit + unit );
...
</P><P>var rscriptType = ( /^$|^module$|\/(?:java|ecma)script/i );
...
*/
	...
	remove: function( elem, types, handler, selector, mappedTypes ) {
		...
		focus: {</P><P>			// Fire native event if possible so blur/focus sequence is correct
			trigger: function() {
...
</P><P>	// Support: IE &lt;=10 - 11, Edge 12 - 13 only
...
</P><P>		return jQuery( elem ).children( &quot;tbody&quot; )[ 0 ] || elem;
	}
</P><P>	return elem;
}
...
</P><P>						if ( node.src &amp;&amp; ( node.type || &quot;&quot; ).toLowerCase()  !== &quot;module&quot; ) {
...
</P><P>var rboxStyle = new RegExp( cssExpand.join( &quot;|&quot; ), &quot;i&quot; );
</P><P>( function() {
...
</P><P>		container.style.cssText = &quot;position:absolute;left:-11111px;width:60px;&quot; +
...
</P><P>		// Support: Android 4.0 - 4.3 only, Safari &lt;=9.1 - 10.1, iOS &lt;=7.0 - 9.3
...
</P><P>	function roundPixelMeasures( measure ) {
		return Math.round( parseFloat( measure ) );
	}
</P><P>	var pixelPositionVal, boxSizingReliableVal, scrollboxSizeVal, pixelBoxStylesVal,
...
</P><P>function boxModelAdjustment( elem, dimension, box, isBorderBox, styles, computedVal ) {
	var i = dimension === &quot;width&quot; ? 1 : 0,
		extra = 0,
		delta = 0;
</P><P>	// Adjustment may not be necessary
	if ( box === ( isBorderBox ? &quot;border&quot; : &quot;content&quot; ) ) {
		return 0;
	}
</P><P>	for ( ; i &lt; 4; i += 2 ) {
</P><P>		// Both box models exclude margin
		if ( box === &quot;margin&quot; ) {
			delta += jQuery.css( elem, box + cssExpand[ i ], true, styles );
		}
</P><P>		// If we get here with a content-box, we're seeking &quot;padding&quot; or &quot;border&quot; or &quot;margin&quot;
		if ( !isBorderBox ) {
</P><P>			// Add padding
			delta += jQuery.css( elem, &quot;padding&quot; + cssExpand[ i ], true, styles );
</P><P>			// For &quot;border&quot; or &quot;margin&quot;, add border
			if ( box !== &quot;padding&quot; ) {
				delta += jQuery.css( elem, &quot;border&quot; + cssExpand[ i ] + &quot;Width&quot;, true, styles );
</P><P>			// But still keep track of it otherwise
			} else {
				extra += jQuery.css( elem, &quot;border&quot; + cssExpand[ i ] + &quot;Width&quot;, true, styles );
			}
</P><P>		// If we get here with a border-box (content + padding + border), we're seeking &quot;content&quot; or
		// &quot;padding&quot; or &quot;margin&quot;
		} else {
</P><P>			// For &quot;content&quot;, subtract padding
			if ( box === &quot;content&quot; ) {
				delta -= jQuery.css( elem, &quot;padding&quot; + cssExpand[ i ], true, styles );
			}
</P><P>			// For &quot;content&quot; or &quot;padding&quot;, subtract border
			if ( box !== &quot;margin&quot; ) {
				delta -= jQuery.css( elem, &quot;border&quot; + cssExpand[ i ] + &quot;Width&quot;, true, styles );
			}
		}
	}
</P><P>	// Account for positive content-box scroll gutter when requested by providing computedVal
	if ( !isBorderBox &amp;&amp; computedVal &gt;= 0 ) {
</P><P>		// offsetWidth/offsetHeight is a rounded sum of content, padding, scroll gutter, and border
...
</P><P>function getWidthOrHeight( elem, dimension, extra ) {
...
</P><P>	// Fall back to offsetWidth/offsetHeight when value is &quot;auto&quot;
	// This happens for inline elements with no explicit setting (gh-3571)
	// Support: Android &lt;=4.1 - 4.3 only
	// Also use offsetWidth/offsetHeight for misreported inline dimensions (gh-3602)
	if ( val === &quot;auto&quot; ||
		!parseFloat( val ) &amp;&amp; jQuery.css( elem, &quot;display&quot;, false, styles ) === &quot;inline&quot; ) {
</P><P>		val = elem[ &quot;offset&quot; + dimension[ 0 ].toUpperCase() + dimension.slice( 1 ) ];
</P><P>		// offsetWidth/offsetHeight provide border-box values
		valueIsBorderBox = true;
	}
</P><P>	// Normalize &quot;&quot; and auto
	val = parseFloat( val ) || 0;
</P><P>	// Adjust for the element's box model
	return ( val +
		boxModelAdjustment(
			elem,
			dimension,
			...
			valueIsBorderBox,
			styles,
</P><P>			// Provide the current computed size to request scroll gutter calculation (gh-3589)
			val
		)
	) + &quot;px&quot;;
}
...
</P><P>jQuery.each( [ &quot;height&quot;, &quot;width&quot; ], function( i, dimension ) {
	jQuery.cssHooks[ dimension ] = {
		get: function( elem, computed, extra ) {
...
</P><P>			// Account for unreliable border-box dimensions by comparing offset* to computed and
			...
			if ( subtract &amp;&amp; ( matches = rcssNum.exec( value ) ) &amp;&amp;
				( matches[ 3 ] || &quot;px&quot; ) !== &quot;px&quot; ) {
</P><P>				elem.style[ dimension ] = value;
...
</P><P>		// Support: IE &lt;=9 - 11, Edge 12 - 15
...
</P><P>	if ( isFunction( animation.opts.start ) ) {
...
if ( !support.optSelected ) {
	...
	// <A rel="nofollow" class="external free" href="https://infra.spec.whatwg.org/#strip-and-collapse-ascii-whitespace">https://infra.spec.whatwg.org/#strip-and-collapse-ascii-whitespace</A>
...
</P><P>function classesToArray( value ) {
	if ( Array.isArray( value ) ) {
		return value;
	}
...
</P><P>		classes = classesToArray( value );
</P><P>		if ( classes.length ) {
			while ( ( elem = this[ i++ ] ) ) {
...
</P><P>		if ( typeof stateVal === &quot;boolean&quot; &amp;&amp; isValidValue ) {
...
</P><P>		valueIsFunction = isFunction( value );
</P><P>		return this.each( function( i ) {
			var val;
</P><P>			if ( this.nodeType !== 1 ) {
				return;
			}
</P><P>			if ( valueIsFunction ) {
...
</P><P>		var i, cur, tmp, bubbleType, ontype, handle, special, lastElement,
			eventPath = [ elem || document ],
			type = hasOwn.call( event, &quot;type&quot; ) ? event.type : event,
			namespaces = hasOwn.call( event, &quot;namespace&quot; ) ? event.namespace.split( &quot;.&quot; ) : [];
</P><P>		cur = lastElement = tmp = elem = elem || document;
...
</P><P>					if ( event.isPropagationStopped() ) {
...
</P><P>					jQuery.event.triggered = undefined;
</P><P>					if ( tmp ) {
						elem[ ontype ] = tmp;
					}
				}
...
</P><P>	} else if ( !traditional &amp;&amp; toType( obj ) === &quot;object&quot; ) {
...
</P><P>			// Support: IE &lt;=8 - 11, Edge 12 - 15
...
</P><P>			// If data is available and should be processed, append data to url
			if ( s.data &amp;&amp; ( s.processData || typeof s.data === &quot;string&quot; ) ) {
...
</P><P>	// offset() relates an element's border box to the document origin
...
</P><P>		// Get document-relative position by adding viewport scroll to viewport-relative gBCR
...
</P><P>	// position() relates an element's margin box to its offset parent's padding box
	// This corresponds to the behavior of CSS absolute positioning
	position: function() {
		if ( !this[ 0 ] ) {
			return;
		}
</P><P>		var offsetParent, offset, doc,
			elem = this[ 0 ],
			parentOffset = { top: 0, left: 0 };
</P><P>		// position:fixed elements are offset from the viewport, which itself always has zero offset
		if ( jQuery.css( elem, &quot;position&quot; ) === &quot;fixed&quot; ) {
</P><P>			// Assume position:fixed implies availability of getBoundingClientRect
			offset = elem.getBoundingClientRect();
</P><P>		} else {
			offset = this.offset();
</P><P>			// Account for the *real* offset parent, which can be the document or its root element
...
</P><P>				offsetParent = offsetParent.parentNode;
			}
			if ( offsetParent &amp;&amp; offsetParent !== elem &amp;&amp; offsetParent.nodeType === 1 ) {
</P><P>				// Incorporate borders into its offset, since they are outside its content origin
...
jQuery.type = toType;
</P><P>jQuery.now = Date.now;
</P><P>jQuery.isNumeric = function( obj ) {
