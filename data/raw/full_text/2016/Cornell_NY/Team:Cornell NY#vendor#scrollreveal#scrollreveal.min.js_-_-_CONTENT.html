...
<BODY class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Team_Cornell_NY_vendor_scrollreveal_scrollreveal_min_js skin-igem action-view"><DIV id="globalWrapper"><DIV id="content" class="mw-body" role="main"><DIV id="top_title"><H1 id="firstHeading" class="firstHeading"><SPAN dir="auto">Team:Cornell NY/vendor/scrollreveal/scrollreveal.min.js</SPAN></H1></DIV><DIV id="HQ_page"><DIV id="bodyContent"><DIV id="mw-content-text" lang="en" dir="ltr" class="mw-content-ltr"><P>(function(root, factory) {
...
*/
</PRE><DL><DT>(function() {</DT></DL><PRE>   'use strict';
</PRE><PRE>   var
       sr,
       Tools,
       _requestAnimationFrame;
</PRE><PRE>   this.ScrollReveal = (function() {
</PRE><PRE>       /**
        * Configuration
        * -------------
        ...
        */
</PRE><PRE>       ScrollReveal.prototype.defaults = {
</PRE><PRE>           //            'bottom', 'left', 'top', 'right'
           origin      : 'bottom',
</PRE><PRE>           //            Can be any valid CSS distance, e.g. '5rem', '10%', '20vw', etc.
           distance    : '20px',
</PRE><PRE>           //            Time in milliseconds.
           duration    : 500,
           delay       : 0,
</PRE><PRE>           //            Starting angles in degrees, will transition from these values to 0 in all axes.
           rotate      : { x: 0, y: 0, z: 0 },
</PRE><PRE>           //            Starting opacity value, before transitioning to the computed opacity.
           opacity     : 0,
</PRE><PRE>           //            Starting scale value, will transition from this value to 1
           scale       : 0.9,
</PRE><PRE>           //            Accepts any valid CSS easing, e.g. 'ease', 'ease-in-out', 'linear', etc.
           easing      : 'cubic-bezier(0.6, 0.2, 0.1, 1)',
</PRE><PRE>           //            When null, `` is assumed to be the reveal container. You can pass a
        ...
        function _resolveContainer(config) {
            ...
            // Check if our container is defined by a node.
                ...
                console.log('ScrollReveal: Invalid container provided, using  instead.');
