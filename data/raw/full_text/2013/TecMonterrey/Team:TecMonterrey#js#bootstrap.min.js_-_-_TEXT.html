...
Log in
 
Team:TecMonterrey/js/bootstrap.min.js
From 2013.igem.org
/**
...
',item:'
<a href="#"></a></li>',minLength:1},a.fn.typeahead.Constructor=b,a(function(){a("body").on("focus.typeahead.data-api",'[data-provide="typeahead"]',function(b){var c=a(this);if(c.data("typeahead"))return;b.preventDefault(),c.typeahead(c.data())})})}(window.jQuery)
Retrieved from " http://2013.igem.org/Team:TecMonterrey/js/bootstrap.min.js "
Recent changes
What links here
Related changes
Special pages
